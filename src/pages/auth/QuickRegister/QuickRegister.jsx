...
const QuickRegister = () => {
  ...
  const config = TENANT_CONFIG[selectedPrefix] ?? TENANT_CONFIG['KV'];
  ...
  useEffect(() => {
    ...
    if (detectedPrefix) setSelectedPrefix(detectedPrefix);
  }, [tenant, detectedPrefix]);

  // ── Cuando cambia el país, resetear campos dependientes ───────────────────
  useEffect(() => {
  ...
  const validateForm = () => {
    ...
    else { const pv = validatePassword(formData.password); if (!pv.isValid) newErrors.password = pv.errors[0]; }
  ...
  return (
    <div className="quick-register" data-theme={actualTheme}>
      <div className="quick-register__container">
        ...
        {/* Formulario — solo cuando hay país */}
          ...
          <form onSubmit={handleSubmit} className="quick-register__form">
            ...
            <div className="form-group">
              ...
              <div className="password-container">
                ...
                <button type="button" className="password-toggle"
                  onClick={() => setShowConfirmPassword(p => !p)} tabIndex="-1">
            ...
            <div className="form-group">
              ...
              <input type="text" name="nombres" value={formData.nombres}
                onChange={handleChange} placeholder="Juan" maxLength={50}
            ...
            <div className="form-group">
              ...
              <input type="text" name="apellidos" value={formData.apellidos}
                onChange={handleChange} placeholder="García López" maxLength={50}
            ...
            <div className="form-group">
              ...
              <input type="text" name="nroDocumento" value={formData.nroDocumento}
                onChange={handleChange} placeholder={docConfig?.placeholder}
            ...
            <div className="form-group">
              ...
              <div className="phone-input">
                ...
                <input type="tel" name="telefono" value={formData.telefono}
                  onChange={handleChange} placeholder={config.telefonoPlaceholder}
                  maxLength={config.telefonoDigitos} inputMode="numeric"
            ...
            {/* Submit */}
            <button type="submit" className="quick-register__submit"
